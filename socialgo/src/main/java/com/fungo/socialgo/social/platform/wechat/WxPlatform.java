package com.fungo.socialgo.social.platform.wechat;
...
import com.fungo.socialgo.social.common.SocialConstants;
import com.fungo.socialgo.social.common.ThumbDataContinuation;
...
import com.fungo.socialgo.social.platform.AbsPlatform;
import com.fungo.socialgo.social.platform.IPlatform;
import com.fungo.socialgo.social.platform.PlatformCreator;
import com.fungo.socialgo.social.platform.Target;
import com.fungo.socialgo.social.util.BitmapUtil;
import com.fungo.socialgo.social.util.FileUtil;
import com.fungo.socialgo.social.util.SocialLogUtil;
import com.fungo.socialgo.social.util.Util;
...
//        com.fungo.socialgo.workflow.Task.call(com.fungo.socialgo.workflow.Task.BG, new CallAction<byte[]>() {
//            @Override
//            public byte[] call() {
//                return BitmapUtil.getStaticSizeBitmapByteByPath(obj.getThumbImagePath(), THUMB_IMAGE_SIZE);
//            }
//        }).then(com.fungo.socialgo.workflow.Task.UI, new TaskAction<byte[], Boolean>() {
//            @Override
